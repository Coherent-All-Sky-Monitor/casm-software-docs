...
Source baseline: `8b5fcf5b089d`. Generated by static parsing; no package imports. These are selected defining modules, not a claim that every symbol is re-exported at the package root. Docstrings below are unedited source text and may need scientific qualification.
