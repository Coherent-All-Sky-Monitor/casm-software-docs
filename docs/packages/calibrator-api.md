...
Source baseline: `80142218ef71`. Generated by static parsing; no package imports. These are selected defining modules, not a claim that every symbol is re-exported at the package root. Docstrings below are unedited source text and may need scientific qualification.
...
[Baseline source](https://github.com/Coherent-All-Sky-Monitor/casm_calibrator/blob/80142218ef7158f37e2d9fd4a485f3c3da7bc90d/src/casm_calibrator/__init__.py) · snapshot hash `14e815676c05`


## casm_calibrator.calibration

```{py:currentmodule} casm_calibrator.calibration
```

[Baseline source](https://github.com/Coherent-All-Sky-Monitor/casm_calibrator/blob/80142218ef7158f37e2d9fd4a485f3c3da7bc90d/src/casm_calibrator/calibration.py) · snapshot hash `6c9365c7184e`
...
## casm_calibrator.results

```{py:currentmodule} casm_calibrator.results
```

[Baseline source](https://github.com/Coherent-All-Sky-Monitor/casm_calibrator/blob/80142218ef7158f37e2d9fd4a485f3c3da7bc90d/src/casm_calibrator/results.py) · snapshot hash `3db07539aa5b`
...
## casm_calibrator.products

```{py:currentmodule} casm_calibrator.products
```

[Baseline source](https://github.com/Coherent-All-Sky-Monitor/casm_calibrator/blob/80142218ef7158f37e2d9fd4a485f3c3da7bc90d/src/casm_calibrator/products.py) · snapshot hash `ac4838f12318`
...
[Baseline source](https://github.com/Coherent-All-Sky-Monitor/casm_calibrator/blob/80142218ef7158f37e2d9fd4a485f3c3da7bc90d/src/casm_calibrator/svd.py) · snapshot hash `b9489b0270c0`
...
[Baseline source](https://github.com/Coherent-All-Sky-Monitor/casm_calibrator/blob/80142218ef7158f37e2d9fd4a485f3c3da7bc90d/src/casm_calibrator/output.py) · snapshot hash `5c6705df0f14`
