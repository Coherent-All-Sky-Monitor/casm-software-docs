...
Source baseline: `af8ecd07fcd7`. Generated by static parsing; no package imports. These are selected defining modules, not a claim that every symbol is re-exported at the package root. Docstrings below are unedited source text and may need scientific qualification.
...
[Baseline source](https://github.com/Coherent-All-Sky-Monitor/casm_vis_analysis/blob/af8ecd07fcd761cb733d622c266a8d2188444414/src/casm_vis_analysis/runners.py) · snapshot hash `e48abff934a6`
...
[Baseline source](https://github.com/Coherent-All-Sky-Monitor/casm_vis_analysis/blob/af8ecd07fcd761cb733d622c266a8d2188444414/src/casm_vis_analysis/sources.py) · snapshot hash `b005477ce6ed`
...
[Baseline source](https://github.com/Coherent-All-Sky-Monitor/casm_vis_analysis/blob/af8ecd07fcd761cb733d622c266a8d2188444414/src/casm_vis_analysis/fringe_stop.py) · snapshot hash `8c12b5c4323c`
...
[Baseline source](https://github.com/Coherent-All-Sky-Monitor/casm_vis_analysis/blob/af8ecd07fcd761cb733d622c266a8d2188444414/src/casm_vis_analysis/delay.py) · snapshot hash `b1541157146d`
...
[Baseline source](https://github.com/Coherent-All-Sky-Monitor/casm_vis_analysis/blob/af8ecd07fcd761cb733d622c266a8d2188444414/src/casm_vis_analysis/solar_waterfall.py) · snapshot hash `034bcf149a27`
...
```{py:function} plot_dynamic_spectrum(spec, time_unix, freq_mhz, out_path=None, *, title='CASM Dynamic Spectrum', chans=None, tz=DEFAULT_TZ, cmap=DEFAULT_CMAP, quantity='Power', integration_s=None)
```
...
[Baseline source](https://github.com/Coherent-All-Sky-Monitor/casm_vis_analysis/blob/af8ecd07fcd761cb733d622c266a8d2188444414/src/casm_vis_analysis/beam_power.py) · snapshot hash `c2cf1b1a3871`
...
[Baseline source](https://github.com/Coherent-All-Sky-Monitor/casm_vis_analysis/blob/af8ecd07fcd761cb733d622c266a8d2188444414/src/casm_vis_analysis/plotting/phase_freq.py) · snapshot hash `b2db11cb0215`
