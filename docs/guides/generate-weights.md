...
Read [rank-1 diagnostics](rank1-diagnostics.md) and run the
[cross-day phase and Cyg A checks](check-calibration.md). Calibration generation
and [deployment](deploy-weights.md) are separate stages.
