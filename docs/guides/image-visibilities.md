# Image the sky by beamforming visibilities
...
[Read and inspect visibilities](read-visibilities.md). The imaging package is
...
not automatically a null. See [Check whether a calibration transfers](check-calibration.md).
